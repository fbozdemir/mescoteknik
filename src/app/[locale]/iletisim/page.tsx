        ...
        <div className="max-w-[1600px] mx-auto px-6 md:px-24 mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            ...
            <div className="order-2 lg:order-1">
              <h2 className="text-[#258535] text-[39px] md:text-[40px] leading-[47px] md:leading-[48px] font-medium mb-6">Bize Yazın</h2>
              <p className="text-[#606060] text-[18px] md:text-[19px] leading-[28px] md:leading-[29px] font-light mb-8">Uzman ekibimiz talebinize en kısa sürede cevap verecektir.</p>
              <ContactForm />
            </div>

            {/* Contact Information Section */}
            <div className="lg:pl-20 order-1 lg:order-2">
              <h2 className="text-[#258535] text-[39px] md:text-[40px] leading-[47px] md:leading-[48px] font-medium mb-6">Bize Ulaşın</h2>
                ...
                <div>
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <a href="tel:+905332244537" className="block hover:text-[#258535] transition-colors text-[19px] md:text-[20px] leading-[29px] md:leading-[30px] font-normal text-[#696969]">+90 533 224 45 37</a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <a href="mailto:cem@mescoteknik.com" className="block hover:text-[#258535] transition-colors text-[19px] md:text-[20px] leading-[29px] md:leading-[30px] font-normal text-[#696969]">cem@mescoteknik.com</a>
                      </div>
                    </div>
                  ...
                  <div className="mt-8 pl-8">
                    ...
                    >
                      <span className="text-[19px] md:text-[20px] leading-[29px] md:leading-[30px] font-normal text-[#696969] hover:text-[#258535] transition-colors">HARİTADA GÖR</span>
                      <div className="text-[#258535]">
                        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
