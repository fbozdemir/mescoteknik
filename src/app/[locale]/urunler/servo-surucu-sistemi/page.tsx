...
const HeroSection = () => (
  <div className="relative h-[250px] md:h-[425px] overflow-hidden mt-24">
    ...
    <div className="absolute inset-0 bg-fixed bg-cover bg-center bg-no-repeat" 
         style={{backgroundImage: 'url(/images/product-groups/servo-surucu.jpg)'}}>
...
export default function ServoSurucuSistemi() {
  ...
  return (
    <div className="min-h-screen bg-white">
              ...
              <div className="max-w-xl">
                ...
                <div className="mb-8 space-y-4">
                  <p className="font-light text-[20px] leading-[30px]" style={{ color: 'rgb(105, 105, 105)' }}>
                    Servo Sürücü Modelimiz, Projeye Göre İstenen Genişliklerde Üretilmesinin Yanı Sıra, Tasarımına Yardımcı Ekipmanlar Eklenerek Plaka Sac Sürücü Olarak da Kullanım İmkanına Sahiptir.
                  </p>
                </div>
            ...
            <div className="order-2 lg:order-2">
              <div className="relative">
                <div className="aspect-[9/6] relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-50 to-gray-100">
                  <Image
                    src="/images/product-groups/servo-surucu.jpg"
                    alt="Servo Sürücü Sistemi"
                    fill
        ...
        <div className="mb-12 border border-gray-200 rounded-lg p-12 bg-white">
          ...
          <div className="mb-8">
            <p className="font-light text-[20px] leading-[30px] mb-4" style={{ color: 'rgb(105, 105, 105)' }}>
              <span className="font-bold">RMC Model</span> Kasalı Rulo Sac Servo Sürücü Modellerimiz, 300 mm ile 1600 mm Sac Genişliklerinde Çalışmaktadır. Rulo Sac Besleme Sac Kalınlığı Kapasitesi 0,4 mm ile 3mm Aralığındadır.
            </p>
            <p className="font-light text-[20px] leading-[30px] mb-8" style={{ color: 'rgb(105, 105, 105)' }}>
              Ayrıca Ürünümüz Yardımcı Ekipmanlar ile Plaka Sac Sürücü Olarak Kullanılmaktadır.
            </p>
          </div>
      ...
      <QuoteForm 
        ...
        productName="Servo Sürücü Sistemi"
      />
    </div>
  )
} 