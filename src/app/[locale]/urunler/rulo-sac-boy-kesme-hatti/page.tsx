...
const HeroSection = () => (
  <div className="relative h-[250px] md:h-[425px] overflow-hidden mt-24">
    ...
    <div className="absolute inset-0 bg-fixed bg-cover bg-center bg-no-repeat" 
         style={{backgroundImage: 'url(/images/product-groups/rulo-sac-boy-kesme.jpg)'}}>
...
export default function RuloSacBoyKesmeHatti() {
  ...
  return (
    <div className="min-h-screen bg-white">
              ...
              <div className="max-w-xl">
                ...
                <div className="mb-8 space-y-4">
                  <p className="font-light text-[20px] leading-[30px]" style={{ color: 'rgb(105, 105, 105)' }}>
                    Hedefimiz, Sürekli Yenilenen ve Geliştirilen ARGE Çalışmalarımızla Müşterilerimizin Beklentilerinin ve İhtiyaçlarının Ötesinde Çözümler Sunarak Üretim Kapasitelerini Artırırken, Üretim Kalitesinde Sürekliliği Sağlamaktır.
                  </p>
                </div>
            ...
            <div className="order-2 lg:order-2">
              <div className="relative">
                <div className="aspect-[9/6] relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-50 to-gray-100">
                  <Image
                    src="/images/product-groups/rulo-sac-boy-kesme.jpg"
                    alt="Rulo Sac Boy Kesme Hattı"
                    fill
        ...
        <div className="mb-12 border border-gray-200 rounded-lg p-12 bg-white">
          ...
          <div className="mb-8">
            <p className="font-light text-[20px] leading-[30px] mb-8" style={{ color: 'rgb(105, 105, 105)' }}>
              Rulo Sac Boy Kesme Hatlarımız, Baştan Sona Projeye Özel Çözümlere Odaklı Ekipmanlarla Donatılmıştır.
            </p>
          </div>
          ...
          <div className="mb-8">
            ...
            <div className="space-y-3">
              {[
                'Yüksek Seviyede Otomasyon ile Kolay Kullanım',
                'Düşük İşletme Maliyet, Yüksek Kalite, Maksimum Verimlilik',
                'Yüksek Kapasite, Kompakt Tasarım',
                'Projeye Özel Doğrultma Sistemi ile Maksimum Yüzey Doğruluğu',
                'Malzemeye Özel Kalitede Merdaneler ve Taşıyıcılar ile Hassas Üretim',
                'Çapaksız ve Yüksek Kaliteli Kesim',
                'Otomatik İstifleme Çözümü'
              ].map((feature, index) => (
      ...
      <QuoteForm 
        ...
        productName="Rulo Sac Boy Kesme Hattı"
      />
    </div>
  )
}
