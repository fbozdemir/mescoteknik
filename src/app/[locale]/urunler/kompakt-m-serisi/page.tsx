...
const HeroSection = () => (
  <div className="relative h-[250px] md:h-[425px] overflow-hidden mt-24">
    ...
    <div className="absolute inset-0">
      <Image
        src="/images/product-groups/m-series-compact-press-feeding-system.jpg"
        alt="Kompakt M Serisi Background"
        fill
...
export default function KompaktMSerisi() {
        ...
        <div className="mb-12 border border-gray-200 rounded-lg p-12 bg-white">
          ...
          <div className="mb-8">
            <p className="font-light text-[20px] leading-[30px] mb-8" style={{ color: 'rgb(105, 105, 105)' }}>
              Kompakt Sistem Pres Besleme Makinalarımız, 60 – 1300 mm Rulo Sac Genişliği, 0.5 – 4 mm Sac Kalınlığı, 4.000 Kg ile 10.000 Kg  Rulo Ağırlığı Kapasiteli Rulo Açma, Doğrultma ve Sürme Sistemlerinden Oluşmaktadır.
            </p>
          </div>
          ...
          <div className="mb-8">
            ...
            <div className="space-y-3">
              {[
                'Hidrolik Rulo Sac Açma Makinesi',
                'Hidrolik Yükleme Arabası',
                'Hidrolik İç Sıkma / Boşaltma',
                'Rulo Üst Baskı Kolu (Hidrolik & Pnömatik)',
                'Rulo Alt Baskı Kolu Motorlu ( Hidrolik / Pnömatik )',
                'Rulo Açılış-Sac Yönlendirme Platformu',
                'Rulo Açılış- Bel Kırma',
                ...
                'Kalıp Hafıza Sistemi & Çoklu Harici Çıkış Seçeneği',
