...
const HeroSection = () => (
  <div className="relative h-[250px] md:h-[425px] overflow-hidden mt-24">
    ...
    <div className="absolute inset-0 bg-fixed bg-cover bg-center bg-no-repeat" 
         style={{backgroundImage: 'url(/images/product-groups/zigzag-surucu.jpg)'}}>
...
export default function ZigzagSurucuSistemi() {
  ...
  return (
    <div className="min-h-screen bg-white">
              ...
              <div className="max-w-xl">
                ...
                <div className="mb-8 space-y-4">
                  <p className="font-light text-[20px] leading-[30px]" style={{ color: 'rgb(105, 105, 105)' }}>
                    Çevre/Pul Kesme İşlemlerinde, İki Eksende (X ve Y) Hareket Edebilen Zigzag Servo Sürücü Sistemi Özellikle Minimum Fire Tasarrufu İçin Tercih Edilmektedir.
                  </p>
                  <p className="font-light text-[20px] leading-[30px]" style={{ color: 'rgb(105, 105, 105)' }}>
                    Sahip Olduğu Gövde Yapısıyla, Her Türlü Prese Kolaylıkla adapte Edilebilir.
                  </p>
                </div>
            ...
            <div className="order-2 lg:order-2">
              <div className="relative">
                <div className="aspect-[9/6] relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-50 to-gray-100">
                  <Image
                    src="/images/product-groups/zigzag-surucu.jpg"
                    alt="Zigzag Sürücü Sistemi"
                    fill
        ...
        <div className="mb-12 border border-gray-200 rounded-lg p-12 bg-white">
          ...
          <div className="mb-8">
            <p className="font-light text-[20px] leading-[30px] mb-4" style={{ color: 'rgb(105, 105, 105)' }}>
              <span className="font-bold">Zigzag Servo Sürücü Sistemi;</span> Rulo Açıcı, Doğrultma ve İki Eksende hareketli Servo Sürücü Ünitelerinden Oluşmaktadır.
            </p>
            <p className="font-light text-[20px] leading-[30px] mb-8" style={{ color: 'rgb(105, 105, 105)' }}>
              Özel Tasarımımız Her Türlü Presle Uyumlu Çalışma İmkanı Sunar.
            </p>
          </div>
          ...
          <div className="mb-8">
            ...
            <div className="space-y-3">
              {[
                'Hidrolik / Mekanik Rulo Açma Sistemi',
                'Hidrolik Yükleme Arabası',
                'Rulo Sac Otomatik Merkezleme Sistemi',
                'Alt ve Üst Baskı Kolu (Hidrolik / Pnömatik)',
                'Sac Yönlendirme Platformu ve Bel Kırma',
                'Açılabilen Doğrultma Merdane Gurubu',
                'Otomatik Doğrultma / Servo Sistem',
                'Loop Kontrol / Laser Sensor',
                'Dişli Aktarım Sistemi / Yüksek Performans',
                'Servo Motorlu Eksen Kontrolü (X ve Y Ekseni)',
                'Çiftli Çekme Merdanesi'
              ].map((feature, index) => (
      ...
      <QuoteForm 
        ...
        productName="Zigzag Sürücü Sistemi"
      />
    </div>
  )
} 