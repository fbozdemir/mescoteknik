...
const HeroSection = () => (
  <div className="relative h-[250px] md:h-[425px] overflow-hidden mt-24">
    ...
    <div className="absolute inset-0 bg-fixed bg-cover bg-center bg-no-repeat" 
         style={{backgroundImage: 'url(/images/product-groups/kdseries.jpg)'}}>
        ...
        <div className="w-full flex justify-start md:justify-between items-center">
          ...
          <div className="flex items-center">
            <h1 className="text-[27px] leading-[32px] md:text-[40px] md:leading-[48px] font-medium text-white">
              Soğuk Şekillendirme Pres Hatları
            </h1>
          </div>
...
export default function SogukSekillendirmePresHatlari() {
    ...
    <div className="min-h-screen bg-white">
              ...
              <div className="max-w-xl">
                ...
                <div className="mb-8 space-y-4">
                  <p className="font-light text-[20px] leading-[30px]" style={{ color: 'rgb(105, 105, 105)' }}>
                    Soğuk şekillendirme teknolojisi, ölçü hassasiyeti yüksek ve iyi yüzey özelliklerine sahip, pek çok farklı ürünün yüksek hızda ve uygun maliyetlerle üretilmesini mümkün kılar. Bu özellikleriyle Fine Blanking , Soğuk Dövme ve Laminasyon Presi teknolojilerini tek  preste bir araya toplar.
                  </p>
                </div>
            ...
            <div className="order-2 lg:order-2">
              <div className="relative max-w-sm md:max-w-md mx-auto">
                <div className="aspect-[4/5] relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-50 to-gray-100">
                  <Image
                    src="/images/product-groups/kdseries.jpg"
                    alt="Soğuk Şekillendirme Pres Hatları"
                    fill
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="border border-gray-200 rounded-lg p-12 bg-white">
          {/* General Features */}
          <div className="mb-8">
            <h2 className="text-[22px] leading-[30px] font-bold mb-6" style={{ color: 'rgb(105, 105, 105)' }}>KD serisi soğuk şekillendirme pres özellikleri;</h2>
            <div className="space-y-3">
              {[
                'Yüksek hassasiyetli parçalarda temiz kenar kesimi',
                'Yüksek geometrik tölerans',
                'Düşük parça deformasyonu, yüksek ürün kalitesi,',
                'Artan ürün mukavemeti,',
                'İkincil işlemeyi ortadan kaldıran veya azaltan teknoloji'
              ].map((feature, index) => (
      ...
      {/* KL Series Product Overview Section */}
      <section className="py-12" style={{ backgroundColor: '#f6f6f6' }}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            {/* Sol Taraf - İçerik */}
            <div className="order-1 lg:order-1">
              <div className="max-w-xl">
                {/* Ana Başlık */}
                <h2 className="font-normal text-[26px] leading-[39px] text-[#258535] mb-8">
                  KL Serisi Soğuk Şekillendirme Pres Hatları
                </h2>
                
                {/* Açıklama */}
                <div className="mb-8 space-y-4">
                  <p className="font-light text-[20px] leading-[30px]" style={{ color: 'rgb(105, 105, 105)' }}>
                    KL serisi soğuk şekillendirme presleri, modern endüstriyel üretimde yüksek kalite ve verimlilik standartlarını karşılamak için tasarlanmıştır. Gelişmiş teknolojisi ile üstün performans sunar.
                  </p>
                </div>
            ...
            <div className="order-2 lg:order-2">
              <div className="relative max-w-lg md:max-w-xl mx-auto">
                <div className="aspect-[4/3] relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-50 to-gray-100">
                  <Image
                    src="/images/product-groups/klseries.jpg"
                    alt="KL Serisi Soğuk Şekillendirme Pres Hatları"
                    fill
                    className="object-cover hover:scale-105 transition-transform duration-700"
                    priority
                  />
      ...
      {/* KL Series Features & Technical Specifications */}
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="border border-gray-200 rounded-lg p-12 bg-white">
          {/* KL Series Features */}
          <div className="mb-8">
            <h2 className="text-[22px] leading-[30px] font-bold mb-6" style={{ color: 'rgb(105, 105, 105)' }}>KL serisi soğuk şekillendirme pres özellikleri;</h2>
            <div className="space-y-3">
              {[
                'İkincil işlemeyi ortadan kaldırın veya azaltın',
                'Daha yüksek malzeme verimi',
                'Daha tutarlı ve kalitesi homojen ürünler,',
                'Optimum malzeme akışı, Geliştirilmiş yüzey kalitesi,',
                'Artırılmış ürün mukavemeti ve tane yapısı iyileştirmesi'
              ].map((feature, index) => (
                <div key={index} className="text-[20px] leading-[30px] font-extralight text-gray-700">
                  {feature}
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="w-full">
              <div className="relative aspect-video overflow-hidden rounded-lg shadow-lg">
                <iframe
                  src="https://www.youtube.com/embed/6ZyjM7oJyAo?start=3"
                  title="Soğuk Şekillendirme Pres Hatları Video 1"
                  frameBorder="0"
            ...
            <div className="w-full">
              <div className="relative aspect-video overflow-hidden rounded-lg shadow-lg">
                <iframe
                  src="https://www.youtube.com/embed/wvh-OOBVgqg"
                  title="Soğuk Şekillendirme Pres Hatları Video 2"
                  frameBorder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                  allowFullScreen
                  className="absolute inset-0 w-full h-full"
      ...
      <QuoteForm 
        ...
        productName="Soğuk Şekillendirme Pres Hatları"
      />
    </div>
  )
}