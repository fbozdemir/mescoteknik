...
const HeroSection = () => (
  <div className="relative h-[250px] md:h-[425px] overflow-hidden mt-24">
    ...
    <div className="absolute inset-0">
      <Image
        src="/images/product-groups/h-series-compact-press-feeding-system.jpg"
        alt="Kompakt H Serisi Background"
        fill
...
export default function KompaktHSerisi() {
        ...
        <div className="mb-12 border border-gray-200 rounded-lg p-12 bg-white">
          ...
          <div className="mb-8">
            <p className="font-light text-[20px] leading-[30px] mb-8" style={{ color: 'rgb(105, 105, 105)' }}>
              Kompakt Besleme Sistemimiz alüminyum, alaşım sıcak ve soğuk materyal, paslanmaz çelik ve diğer yüksek dayanıklı maddeler başta olmak üzere farklı alaşım ve maddeleri işleyebilmektedir.
            </p>
          </div>
