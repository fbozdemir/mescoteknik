...
const HeroSection = () => (
  <div className="relative h-[250px] md:h-[425px] overflow-hidden mt-24">
    ...
    <div className="absolute inset-0 bg-fixed bg-cover bg-center bg-no-repeat" 
         style={{backgroundImage: 'url(/images/product-groups/high-performance-lamination-dies.jpg)'}}>
          ...
          <div className="hidden md:flex items-center">
            <nav className="flex items-center text-base leading-6 font-light text-white">
              ...
              <span className="text-gray-300">
                Yüksek Performanslı Laminasyon Kalıpları
              </span>
            </nav>
          </div>
        </div>
...
export default function YuksekPerformansliLaminasyonKaliplari() {
  ...
  return (
    <div className="min-h-screen bg-white">
              ...
              <div className="max-w-xl">
                ...
                <div className="mb-8 space-y-4">
                  <p className="font-light text-[20px] leading-[30px]" style={{ color: 'rgb(105, 105, 105)' }}>
                    Otomatik istifleme ve döndürme teknolojileri içeren, SKD 11, ASP veya Karbür kesici uçlu, 30 ila 450 Ton presler için tasarlanan yüksek performanslı Laminasyon Pres Kalıpları
                  </p>
                </div>
            ...
            <div className="order-2 lg:order-2">
              <div className="relative">
                <div className="aspect-[9/6] relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-50 to-gray-100">
                  <Image
                    src="/images/product-groups/high-performance-lamination-dies.jpg"
                    alt="Yüksek Performanslı Laminasyon Kalıpları"
                    fill
      ...
      <QuoteForm 
        ...
        productName="Yüksek Performanslı Laminasyon Kalıpları"
      />
    </div>
  )
}