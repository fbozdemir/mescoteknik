...
export default function MiniServoSurucu() {
              ...
              <div className="max-w-xl">
                ...
                <div className="mb-8 space-y-4">
                  <p className="font-light text-[20px] leading-[30px]" style={{ color: 'rgb(105, 105, 105)' }}>
                    Mini Servo Sürücü Tasarımımız, Pres Gövdesine Bağlanabilmesi Sayesinde Kalıp Mesafesini Minimize Ederek Harici Kılavuz İhtiyacını Ortadan Kaldırır.
                  </p>
                </div>
        ...
        <div className="mb-12 border border-gray-200 rounded-lg p-12 bg-white">
          ...
          <div className="mb-8">
            <p className="font-light text-[20px] leading-[30px] mb-8" style={{ color: 'rgb(105, 105, 105)' }}>
              <span className="font-bold">RMF Model</span> Ürünlerimiz, Çalışma Kapasiteleri 0.2 – 3 mm Rulo Sac Kalınlık ve 100 – 600 mm Genişlik Olarak Üretilmektedir.
            </p>
          </div>
