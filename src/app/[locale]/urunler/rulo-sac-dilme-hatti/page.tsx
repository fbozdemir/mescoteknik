...
const HeroSection = () => (
  <div className="relative h-[250px] md:h-[425px] overflow-hidden mt-24">
    ...
    <div className="absolute inset-0 bg-fixed bg-cover bg-center bg-no-repeat" 
         style={{backgroundImage: 'url(/images/product-groups/rulo-sac-dilme.jpg)'}}>
...
export default function RuloSacDilmeHatti() {
  ...
  return (
    <div className="min-h-screen bg-white">
              ...
              <div className="max-w-xl">
                ...
                <div className="mb-8 space-y-4">
                  <p className="font-light text-[20px] leading-[30px]" style={{ color: 'rgb(105, 105, 105)' }}>
                    Rulo Sac Dilme Hatlarımız Müşterilerimizin Özel Talep ve İhtiyaçları Doğrultusunda Tasarlanan Anahtar Teslim Sistemlerdir.
                  </p>
                </div>
            ...
            <div className="order-2 lg:order-2">
              <div className="relative">
                <div className="aspect-[9/6] relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-50 to-gray-100">
                  <Image
                    src="/images/product-groups/rulo-sac-dilme.jpg"
                    alt="Rulo Sac Dilme Hattı"
                    fill
        ...
        <div className="mb-12 border border-gray-200 rounded-lg p-12 bg-white">
          ...
          <div className="mb-8">
            <p className="font-light text-[20px] leading-[30px] mb-4" style={{ color: 'rgb(105, 105, 105)' }}>
              ARGE Ekibimizin Sürekli Yenilenen ve Gelişen Tasarım Çalışmaları, Dilme Hatlarında Sac Dilme Hızını Arttırarak, Yüksek Tonajlı İşler Yapılabilmesini ve Aynı Zamanda Operatörün Daha Hızlı ve Verimli Çalışabilmesini Sağlamaktadır.
            </p>
            <p className="font-light text-[20px] leading-[30px] mb-8" style={{ color: 'rgb(105, 105, 105)' }}>
              Geliştirdiğimiz Tasarımlar Sayesinde, Uluslararası Kalitede Ürettiği Dilme Hatlarını, Çok Daha Uygun ve Ulaşılabilir Maliyetler ile Sunmaktadır.
            </p>
          </div>
          ...
          <div className="mb-8">
            ...
            <div className="space-y-3">
              {[
                'Rulo Yükleme Arabası',
                'Rulo Sac Açıcı Sitemi',
                'Taşıyıcı Transfer Ünitesi',
                'Dilme Ünitesi / Turnike Sistemi',
                'Dilme Bıçakları',
                'Çapak Sarıcıları',
                'Kuyu Kapama ve Transfer Ünitesi',
                'Rulo Sac Gerilim Kontrolü',
                'Seperatör Ünitesi',
      ...
      <QuoteForm 
        ...
        productName="Rulo Sac Dilme Hattı"
      />
    </div>
  )
}
