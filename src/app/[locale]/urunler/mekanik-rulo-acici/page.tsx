...
const HeroSection = () => (
  <div className="relative h-[250px] md:h-[425px] overflow-hidden mt-24">
    ...
    <div className="absolute inset-0">
      <Image
        src="/images/product-groups/mechanical-decoiler.jpg"
        alt="Mekanik Rulo Açıcı Background"
        fill
...
export default function MekanikRuloAcici() {
  ...
  return (
    <div className="min-h-screen bg-white">
              ...
              <div className="max-w-xl">
                ...
                <div className="mb-8 space-y-4">
                  <p className="font-light text-[20px] leading-[30px]" style={{ color: 'rgb(105, 105, 105)' }}>
                    Düşük Ağırlıkta Rulo Kullanımı Gerektiren 
                    Projeler İçin Üretim Yapmakta Olduğumuz 
                    Mekanik Rulo Açıcılar, Loop Kontrollü, 
                    Proximity Sensörlü Hız Kontrollü Özelliklere 
                    Donatılmıştır.
                  </p>
                </div>
            ...
            <div className="order-2 lg:order-2">
              <div className="relative">
                <div className="aspect-[9/6] relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-50 to-gray-100">
                  <Image
                    src="/images/product-groups/mechanical-decoiler1.jpg"
                    alt="Mekanik Rulo Açıcı"
                    fill
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-12 border border-gray-200 rounded-lg p-12 bg-white">
          ...
          <div className="mb-8">
            ...
            <div className="space-y-3">
              {[
                ...
                'Üst Baskı Kolu',
                'Hızı Kontrolü/ Potansiyometre',
                'Mesafe Algılama / Ayar Sensörü',
                'Fren Sistemi'
              ].map((feature, index) => (
          ...
          <table className="w-full border-collapse border border-gray-300">
            ...
            <tbody>
              {[
                ['RM750M', '20 - 300', '300', '550', 'Ø 1400 / 1600', '750 Kg', '+', '-', 'Opsiyonel'],
                ['RM750F', '20 - 300', '300', '550', 'Ø 1400 / 1600', '750 Kg', '-', '+', 'Opsiyonel'],
                ['RM1000M', '20 - 300', '300', '550', 'Ø 1400 / 1600', '1000 Kg', '+', '-', 'Opsiyonel'],
                ['RM1000F', '20 - 300', '300', '550', 'Ø 1400 / 1600', '1000 Kg', '-', '+', 'Opsiyonel'],
                ['RM2500M', '30 - 500', '400', '550', 'Ø 1400 / 1600', '2500 Kg', '+', '-', 'Opsiyonel'],
                ['RM2500F', '20 - 500', '400', '550', 'Ø 1400 / 1600', '2500 Kg', '-', '+', 'Opsiyonel'],
                ['RMK4000M', '30 - 600 / 1600', '470', '530', 'Ø 1400 / 1600', '4000 Kg', '+', '-', 'Opsiyonel'],
                ['RMK4000M', '30 - 600 / 1600', '470', '530', 'Ø 1400 / 1600', '4000 Kg', '-', '+', 'Opsiyonel']
              ].map((row, index) => (
      ...
      <QuoteForm 
        ...
        productName="Mekanik Rulo Açıcı"
      />
    </div>
  )
}