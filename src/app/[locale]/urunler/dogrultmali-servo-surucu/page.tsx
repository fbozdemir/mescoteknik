...
const HeroSection = () => (
  <div className="relative h-[250px] md:h-[425px] overflow-hidden mt-24">
    ...
    <div className="absolute inset-0 bg-fixed bg-cover bg-center bg-no-repeat" 
         style={{backgroundImage: 'url(/images/product-groups/dogrultmali-servo.jpg)'}}>
...
export default function DogrultmaliServoSurucu() {
  ...
  return (
    <div className="min-h-screen bg-white">
            ...
            <div className="order-1 lg:order-1">
              <div className="max-w-xl">
                ...
                <p className="font-thin text-[16px] leading-[24px] mb-4" style={{ color: 'rgb(105, 105, 105)' }}>
                  Doğrultmalı Servo Sürücü Sistemleri
                </p>
                ...
                <div className="mb-8 space-y-4">
                  <p className="font-light text-[20px] leading-[30px]" style={{ color: 'rgb(105, 105, 105)' }}>
                    Doğrultmalı Servo Sürücü Sistemi, Sürme ve Doğrultma Kombinasyonunu Birlikte Sağlamasının yanı Sıra, Yüksek Performanslı Preslerde Hızlı ve Yüksek Hassasiyetle Çalışma İmkânı da Sunar.
                  </p>
                </div>
            ...
            <div className="order-2 lg:order-2">
              <div className="relative">
                <div className="aspect-[9/6] relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-50 to-gray-100">
                  <Image
                    src="/images/product-groups/dogrultmali-servo.jpg"
                    alt="Doğrultmalı Servo Sürücü"
                    fill
        ...
        <div className="mb-12 border border-gray-200 rounded-lg p-12 bg-white">
          ...
          <div className="mb-8">
            <p className="font-light text-[20px] leading-[30px] mb-4" style={{ color: 'rgb(105, 105, 105)' }}>
              <span className="font-bold">RMS Serisi</span> Doğrultmalı Servo Sürücülerimiz Rulo Sac Malzeme Kalitesi, Kalınlığı ve Genişliğine Göre 3 Farklı Modelimizle Üretilmektedir. <span className="font-bold">RMS-9 / RMS-11 / RMS-12</span>
            </p>
            <p className="font-light text-[20px] leading-[30px] mb-8" style={{ color: 'rgb(105, 105, 105)' }}>
              Metal İşlemede Birçok Alanda Kullanılan Doğrultmalı Servo Sürücülerimiz Müşterilerimizin Üretimine Hassas ve Hızlı Çözümler Sunmaktadır.
            </p>
          </div>
          ...
          <div className="mb-8">
            ...
            <div className="space-y-3">
              {[
                'Merdane Gurubu – Dişli Aktarım Sistemi',
      ...
      <QuoteForm 
        ...
        productName="Doğrultmalı Servo Sürücü"
      />
    </div>
  )
} 