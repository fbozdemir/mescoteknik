...
const HeroSection = () => (
  <div className="relative h-[250px] md:h-[425px] overflow-hidden mt-24">
    ...
    <div className="absolute inset-0 bg-fixed bg-cover bg-center bg-no-repeat" 
         style={{backgroundImage: 'url(/images/product-groups/iskele-kalas.jpg)'}}>
...
export default function IskeleKalasUretimHatti() {
  ...
  return (
    <div className="min-h-screen bg-white">
              ...
              <div className="max-w-xl">
                ...
                <div className="mb-8 space-y-4">
                  <p className="font-light text-[20px] leading-[30px]" style={{ color: 'rgb(105, 105, 105)' }}>
                    İskele Kalas Üretim Hatları Projelerimiz, birçok Alternatif Bileşen İçeren Çözümleri ile Teknik ve Tasarım olarak En Verimli ve Kaliteli Üretimi Hizmetinize Sunar.
                  </p>
                </div>
            ...
            <div className="order-2 lg:order-2">
              <div className="relative">
                <div className="aspect-[9/6] relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-50 to-gray-100">
                  <Image
                    src="/images/product-groups/iskele-kalas.jpg"
                    alt="İskele Kalas Üretim Hattı"
                    fill
        ...
        <div className="mb-12 border border-gray-200 rounded-lg p-12 bg-white">
          ...
          <div className="mb-8">
            <p className="font-light text-[20px] leading-[30px] mb-4" style={{ color: 'rgb(105, 105, 105)' }}>
              Güvenlikli İskele Üretimi konusunda, tecrübeli kadrosu ve profesyonel teknik ekibimiz; talepleriniz doğrultusunda alternatif çözüm önerileri ile, sizlere en hızlı ve verimli üretim sistemlerini sunmaktadır.
            </p>
            <p className="font-light text-[20px] leading-[30px] mb-8" style={{ color: 'rgb(105, 105, 105)' }}>
              İskele Kalas Üretim Hat Bileşenlerinin Her Biri Projeye  Özel Olarak Tasarlanır . Nihai Üründe, Boy Sınırlaması Olmaksızın, İstenen Ölçü ve Toleransta Üretim İmkanı Sunar.
            </p>
          </div>
          ...
          <div className="mb-8">
            ...
            <div className="space-y-3">
              {[
                'Rulo Sac Açıcı Sistemi',
                'Doğrultmalı Servo Sürücü Sistemi',
                'Pres & Kalıp',
                'Rolform Ünitesi',
                'Çıkış-İstif Ünitesi',
      ...
      <QuoteForm 
        ...
        productName="İskele Kalas Üretim Hattı"
      />
    </div>
  )
}