...
const HeroSection = () => (
  <div className="relative h-[250px] md:h-[425px] overflow-hidden mt-24">
    ...
    <div className="absolute inset-0 bg-fixed bg-cover bg-center bg-no-repeat" 
         style={{backgroundImage: 'url(/images/product-groups/cift-kafali-rulo.jpg)'}}>
...
export default function CiftKafaliRuloAcici() {
  ...
  return (
    <div className="min-h-screen bg-white">
              ...
              <div className="max-w-xl">
                ...
                <div className="mb-8 space-y-4">
                  <p className="font-light text-[20px] leading-[30px]" style={{ color: 'rgb(105, 105, 105)' }}>
                    Özel Tasarımımız Olan Çift Kafalı Hidrolik 
                    Rulo Açıcı, 2 Tamburlu Tasarımı sayesinde, 
                    Birinci Tamburda Rulo Sacı Açarken, Diğer 
                    Tamburda Yeni Ruloyu Hazır Olarak Koymak 
                    İçin Tasarlanmıştır. Böylece Prosesi Durdurmadan, 
                    Rulo Yükleme Süresini Minimize Ederek Rulo 
                    Açma İşlemini En Hızlı Şekilde Sağlayabilmektedir.
                  </p>
                </div>
            ...
            <div className="order-2 lg:order-2">
              <div className="relative">
                <div className="aspect-[9/6] relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-50 to-gray-100">
                  <Image
                    src="/images/product-groups/cift-kafali-rulo.jpg"
                    alt="Çift Kafalı Rulo Açıcı"
                    fill
        ...
        <div className="mb-12 border border-gray-200 rounded-lg p-12 bg-white">
          ...
          <div className="mb-8">
            ...
            <div className="space-y-3">
              {[
                'Hız Kontrol Sistemi',
                'Mesafe Ayarlı Sensörü',
                'Ani Durdurma Sistemi /Fren Balata',
                'Konik Mandrel Tasarımı',
                'Çift Yönlü Çalışma Özelliği'
              ].map((feature, index) => (
          ...
          <table className="w-full border-collapse border border-gray-300">
            ...
            <tbody>
              {[
                ['RMX4000HM', '70 - 600', '480', '560', 'Ø 1400 / 1600', '4.000 Kg', 'Hidrolik Sistem', '+', 'Standart'],
                ['RMX6000HM', '70 - 800', '480', '560', 'Ø 1400 / 1600', '6.000 Kg', 'Hidrolik Sistem', '+', 'Standart'],
                ['RMX10000HM', '100 - 1000', '480', '560', 'Ø 1400 / 1600', '10.000 Kg', 'Hidrolik Sistem', '+', 'Standart']
              ].map((row, index) => (
      ...
      <QuoteForm 
        ...
        productName="Çift Kafalı Rulo Açıcı"
      />
    </div>
  )
}