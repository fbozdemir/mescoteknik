...
const HeroSection = () => (
  <div className="relative h-[250px] md:h-[425px] overflow-hidden mt-24">
    ...
    <div className="absolute inset-0 bg-fixed bg-cover bg-center bg-no-repeat" 
         style={{backgroundImage: 'url(/images/product-groups/mini-servo.jpg)'}}>
...
export default function MiniDogrultmaliServoSurucu() {
  ...
  return (
    <div className="min-h-screen bg-white">
              ...
              <div className="max-w-xl">
                ...
                <div className="mb-8 space-y-4">
                  <p className="font-light text-[20px] leading-[30px]" style={{ color: 'rgb(105, 105, 105)' }}>
                    Mini Doğrultmalı Servo Sürücü Tasarımımız, Pres Gövdesine Bağlanabilmesi Sayesinde Kalıp Mesafesini Minimize Ederek Harici Kılavuz İhtiyacını Ortadan Kaldırır.
                  </p>
                </div>
            ...
            <div className="order-2 lg:order-2">
              <div className="relative">
                <div className="aspect-[9/6] relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-50 to-gray-100">
                  <Image
                    src="/images/product-groups/mini-servo.jpg"
                    alt="Mini Doğrultmalı Servo Sürücü"
                    fill
        ...
        <div className="mb-12 border border-gray-200 rounded-lg p-12 bg-white">
          ...
          <div className="mb-8">
            <p className="font-light text-[20px] leading-[30px] mb-8" style={{ color: 'rgb(105, 105, 105)' }}>
              <span className="font-bold">RML Model</span> Makinamız, Özel Tasarımı ve Pilotlama Özelliği Sayesinde Prograsif Kalıp Sistemiyle Entegre Çalışmasının yanı sıra, Kalıpların Uzun Ömürlü Çalışmasın imkan vermektedir.
            </p>
          </div>
          ...
          <div className="mb-8">
            ...
            <div className="space-y-3">
              {[
                'Rulo Sac Doğrultma ve Sürme',
                'Dişli Tahrik Aktarım Sistemi',
                'Servo Motor- Redüktörlü',
                'Ayarlanabilir Çalişma Hızı',
                'Dokunmatik Ekran ile Operasyon',
                '50 Farklı Sürme Boyu',
                'Çoklu Harici Çıkış Seçeneği',
                'Pres Kontrol Otomasyon Sistemi',
      ...
      <QuoteForm 
        ...
        productName="Mini Doğrultmalı Servo Sürücü"
      />
    </div>
  )
} 