...
// Referans firmalar listesi - Gerçek MESCO referansları
const referenceCompanies = [
  {
    ...
    description: "Elektrik motorları için rotor ve stator çözümleri"
  },
  {
    id: 2,
    ...
    description: "Elektrik motor teknolojileri ve çözümleri"
  },
  {
    id: 3,
    ...
    description: "Endüstriyel üretim ve mühendislik çözümleri"
  },
  {
    id: 4,
    ...
    description: "Laminasyon teknolojileri ve çözümleri"
  },
  {
    id: 5,
    ...
    description: "Mühendislik ve endüstriyel çözümler"
  },
  {
    id: 6,
    name: "Teknorot",
    ...
    description: "Otomotiv ve endüstriyel parçalar"
  },
  {
    id: 7,
    name: "Hidria",
    ...
    description: "Otomotiv ve endüstriyel teknolojiler"
  },
  {
    id: 8,
    name: "Tempel",
    ...
    description: "Elektrik motorları için laminasyon çözümleri"
  },
  {
    id: 9,
    name: "Regal",
    ...
    description: "Elektrik motorları ve güç aktarım sistemleri"
  },
  {
    id: 10,
    ...
    description: "Yüksek hassasiyetli damgalama kalıpları"
  },
  {
    id: 11,
    name: "Cummins",
    ...
    description: "Güç çözümleri ve motor teknolojileri"
  },
  {
    id: 12,
  ...
  },
  {
    ...
    description: "Elektrik motorları ve endüstriyel ekipmanlar"
  }
]
          ...
          <div className="max-w-[1600px] mx-auto px-6 md:px-24">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Dünya çapında güvenilen markalarla çalışmaktan gurur duyuyoruz. 
                30 yılı aşkın deneyimimizle, en zorlu projelerde güvenilir çözümler sunuyoruz.
              </p>
            </motion.div>
          </div>
        </section>
                    ...
                    <div className="flex flex-col items-center text-center h-full">
                      ...
                      <div className="flex-1 flex flex-col justify-between min-h-0">
                        ...
                        <div className="flex items-center justify-center text-[#258535] font-medium group-hover:text-[#1a6329] transition-colors duration-300 mt-auto">
                          <span className="text-sm">Web Sitesini Ziyaret Et</span>
        ...
        <div className="max-w-[1600px] mx-auto px-6 md:px-24">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8 leading-relaxed">
                Projeniz için özel çözümler geliştirmek ve uzun vadeli iş ortaklığı kurmak için 
                bizimle iletişime geçin. Deneyimli ekibimiz sizin için en uygun çözümü sunmaya hazır.
              </p>
